      ...
      value: function _updateProductPrices(newVariant, previousVariant) {
        ...
        if (!newVariant) {
          ...
          if (newVariant['compare_at_price'] > newVariant['price']) {
            productMetaPrices.innerHTML += "<span class=\"ProductMeta__Price Price Price--highlight u-h7\" data-money-convertible>".concat(Currency.formatMoney(newVariant['price'], currencyFormat), "</span>");
            productMetaPrices.innerHTML += "<span class=\"ProductMeta__Price Price Price--compareAt u-h7\" data-money-convertible>".concat(Currency.formatMoney(newVariant['compare_at_price'], currencyFormat), "</span>");
          } else {
            productMetaPrices.innerHTML += "<span class=\"ProductMeta__Price Price u-h7\" data-money-convertible>".concat(Currency.formatMoney(newVariant['price'], currencyFormat), "</span>");
          }
  ...
  var CartSection = /*#__PURE__*/function () {
    ...
    _createClass(CartSection, [{
      ...
      value: function _replaceContent(html) {
        ...
        console.log(html.querySelector(".Cart__Checkout").val());
  ...
  var CollectionSection = /*#__PURE__*/function () {
    ...
    _createClass(CollectionSection, [{
      ...
      value: function _onFilterChanged(event) {
        ...
        if((searchParamsAsString.indexOf("size") > -1) && ( window.location.href.indexOf("availability") === -1 )){
          this._reloadProducts("".concat(window.location.pathname, "?filter.v.availability=1&").concat(searchParamsAsString));
        }
        else if((searchParamsAsString.indexOf("size") === -1) && ( window.location.href.indexOf("availability") > -1 )){
          searchParamsAsString = new URLSearchParams(formData);
          searchParamsAsString.delete('filter.v.availability');
          searchParamsAsString = searchParamsAsString.toString();
